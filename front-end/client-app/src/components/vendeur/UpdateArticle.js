...
export default function UpadateArticle() {
    ...
    if (!result) {
        return (
            <div className='form'>
                <Space size="large" className='Spinner' style={{ backgroundColor:"black" }}>
                    <Spin size="large" />
                </Space>
            </div>
        );
            ...
            <section className="section">
                <div className='container'>
                    ...
                    <div className='wrapper form'>
                        ...
                        <Alert
                            message="Warning"
                            description="Noter bien que vous avez ne peut pas changer les images si voulez-vous,  supprimer l'artcile et re-cree"
                            type="warning"
                            style={{
                                width: "700px",
