        ...
        <section id="product_details" className="section">
            <div className="container">
                <div className="wrapper prod_details_wrapper">
                    ...
                    {   products !== undefined || user !== undefined ? (
                        <>
                        <div className="prod_details_right_col">
                        <h1 className="prod_details_title">{products[0].name_article}</h1>
                        <h3 style={{ textAlign:'left' }}>Ville : {products[0].localisation}</h3>
                        ...
                        <div className="prod_details_price">
                            <div className="price_box">
                                <h3 style={{ textAlign:'left' }}> Type de Bien : {products[0].type}</h3>
                                <h3 className="price">
