                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <h1
                                                        style="margin: 0; font-size: 24px; line-height: normal; font-weight: normal;">
                                                        Welcome to H-L Broker</h1>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    <p style="margin-bottom: 0;color:#ffffff">Thank you for using our application. As
                                                        part of our security measures, we have generated a One-Time
                                                        Password (OTP) for you.
                                                    </p>
                                                    <div tyle="margin-bottom: 10px  ;color:#ffffff;margin-top:10px">
                                                        Your OTP: {{ $verificationCode }}
                                                    </div>
                                                    <p style="margin-bottom: 0;color:#ffffff">
                                                         Please use this OTP within the next 60 min minutes to complete your
                                                    authentication. If you did not request this OTP, please disregard
                                                    this email.
                                                    </p>
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#ffffff;">
                                                    <p style="margin-bottom: 0;">If you have any questions simply reply
                                                        to this email and we would be more than happy to reply. :)</p>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <div
                                                    ...
                                                    © 2023 H-L Broker, All rights reserved <br /> Email: <a
                                                        class="footer-link" href="#"
                                                        style="color: #2e58ff; text-decoration: none;">HL.BROCKER@outlook.fr</a>
                                                    <br /> Web: <a class="footer-link" href="#"
                                                        style="color: #2e58ff; text-decoration: none;">http://localhost:3000/</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
